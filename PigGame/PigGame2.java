 ...
 * PigGame.java
 *
 * This program lets a human play the dice game Pig against the computer.
 * The first player to reach at least 100 BANKED points wins.
 *
 * During a turn:
 * - Rolling 2 through 6 adds that roll to the temporary turn score.
 * - Rolling a 1 loses ALL temporary points from that turn and ends the turn.
 * - Holding adds the temporary turn score to the player's permanent score
 *   and ends the turn.
 *
 * The computer keeps rolling until its turn score reaches at least 20.
 * Once it reaches 20 or more, it holds.
 *
 * @author YOUR NAME
 * @since DATE
 */
